# -*- coding: utf-8 -*-
"""Comupter perception.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1v_V08VyvojLAT0UY-H-zE9TglWSzsCfN
"""

#The code is referred to from https://github.com/georgeerol/RoboticPerception
...
def  extract_apple_and_separate_leaves(pcl_data,ransac_segmentation):
    '''
    :param pcl_data:
    ...
    cloud_leaves = pcl_data.extract(inliers, negative=False)
    cloud_apple = pcl_data.extract(inliers, negative=True)
...
def pcl_callback(pcl_msg):
    ...
    cloud_table,cloud_objects= extract_cloud_apple_and_cloud_leaves(cloud,ransac_segmentation )
